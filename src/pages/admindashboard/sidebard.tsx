        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
                    ...
                    <li><Link to="/allbookings">TOTAL BOOKINGS</Link></li>
                    <li><Link to="/managevehicles">MANAGE VEHICLES</Link></li>
                    <li><Link to="/managecustomers">MANAGE USERS</Link></li>
                    {/* <li><Link to="/reports">REPORTS</Link></li> */}
                    <li><Link to="/manage locations">MANAGE LOCAIONS AND BRANCHES</Link></li>
                    <li><Link to="/reports">REPORTS</Link></li>
                    <li><Link to="/create.notification">CUSTOMER SUPPORT TICKETS</Link></li>
